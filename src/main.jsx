      ...
      <section className="landing-grid">
        ...
        <form onSubmit={submit} className="form-card">
          ...
          <details className="fallback-panel">
            ...
            <p>
              Some dealer sites block server-side extraction. When that happens, save the page as a PDF, copy visible page text,
              or paste notes from a screenshot into these fields. The audit will use this pasted content as the primary source for
              any page that cannot be scraped.
            </p>
