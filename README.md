...
The app uses `html2pdf.js` from the browser preview. Before export, the app temporarily applies `body.exporting-pdf`, which:
...
Test `/api/ping`. It should return JSON and show version `1.0.6`.
